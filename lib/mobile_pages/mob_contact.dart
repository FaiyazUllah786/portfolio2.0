...
class MobContactPage extends StatefulWidget {
  const MobContactPage({
    super.key,
  });

  @override
  State<MobContactPage> createState() => _ContactPageState();
}

class _ContactPageState extends State<MobContactPage> {
  ...
  void sendEmail() async {
    ...
    // if (serviceId.isNotEmpty && templateId.isNotEmpty && userId.isNotEmpty) {
      try {
